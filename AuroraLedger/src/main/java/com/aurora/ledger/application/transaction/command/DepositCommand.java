 ...
 * Following Meyer's Command-Query Separation principle, this command modifies state
 * but never returns business data - its success is measured through event emission.
 * 
 * DOMAIN-DRIVEN DESIGN EXCELLENCE (Eric Evans):
 ...
 * Each command carries its creation timestamp, establishing happened-before relationships
 ...
 * Pre-conditions: User exists, amount > 0, sufficient system resources
 * Post-conditions: Balance increased, event emitted, audit trail updated
 ...
 * well-defined interfaces that remain stable even as implementation evolves.
 * 
 * @author Aurora Ledger Engineering Team
 * @pattern Command + Value Object + Domain Model
 * @immutability All fields final, no setters, thread-safe by construction
